...
zenity --info --ok-label= --title=Abriendo_BlueDB --window-icon=/home/pi/V105/ICONO_BLUEDV_ON.png --width=400 --timeout=85 --text "El BlueDv tardará un minuto +- en abrirse \ndependiendo de la velocidad de su Raspberry\nsea paciente y espere que se abra."
