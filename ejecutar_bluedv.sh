...
zenity --warning --ok-label= --title=Abriendo_BlueDB --window-icon=/home/pi/V105/ICONO_BLUEDV_ON.png --width=400 --timeout=20 --text "El BlueDv tardará varios segundos en abrirse \ndependiendo de la velocidad de su Raspberry\nsea paciente y espere que se abra."
