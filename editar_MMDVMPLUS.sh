...
sudo sed -i "6c $memoria1" $usuario/.local/memorias
sudo sed -i "5c $memoria1" $usuario/.local/memorias               
...
sudo sed -i "7c $memoria2" $usuario/.local/memorias
sudo sed -i "5c $memoria2" $usuario/.local/memorias
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
sudo sed -i "8c $memoria3" $usuario/.local/memorias
sudo sed -i "5c $memoria3" $usuario/.local/memorias
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
