...
memoria=$(awk "NR==13" /home/pi/.local/memorias)

#Modificación 31-10-2020
sudo sed -i "1c Indicativo:   $indicativo" /home/pi/.local/memoria_especial
sudo sed -i "2c Id:           $id" /home/pi/.local/memoria_especial
sudo sed -i "3c RXFrecuencia: $rxfrecuencia" /home/pi/.local/memoria_especial
sudo sed -i "4c TXFrecuencia: $txfrecuencia" /home/pi/.local/memoria_especial
